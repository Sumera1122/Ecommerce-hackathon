...
async function ProductDetail({ params }: { params: { slug: string } }) {
  ...
  const res = data.find((item) => item.slug === params.slug);
    ...
    <div className="max-w-4xl mx-auto mt-10 px-4 sm:px-6 md:px-8">
      ...
      <div className="bg-white border rounded-lg shadow-lg overflow-hidden md:flex md:space-x-8 p-6">
        ...
        <div className="md:w-1/3 mb-6 md:mb-0">
          <img
            src={res?.image ? urlFor(res.image).url() : "/default-image.jpg"}
            alt={res?.title || "Product Image"}
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          ...
          {/* Example: Material, Dimensions, etc. */}
...
// this code is written by me but above code is gotten by chargpt due t params error in vercell so i kept both code for my understanding why eror occured
